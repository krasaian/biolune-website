...
const testimonials = [
  ...
  { name: 'Sophia R.', role: 'Startup founder', stat: 'Deep sleep +38% · cortisol normalised', quote: "I was running a Series A on four hours of sleep and completely ignoring my hormones. After three months on Premium, my mental clarity is back. I make better decisions and I can actually feel the difference in board meetings." },
