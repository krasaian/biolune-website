...
const TIER_META: Record<Tier, TierMeta> = {
  ...
  elite: {
    ...
    body: 'You want the deepest layer of the system. Precision medicine, real biomarker tracking, quarterly doctor consults, and a human in the loop. Elite is invite-only. It pairs the adaptive protocol with direct coaching, clinical oversight, and DNA analysis.',
    detail: 'Everything in Precision, plus quarterly doctor consult (video call), full bloodwork read in plain language, long-term biomarker tracking (ApoB, HbA1c, 15+ markers), DNA analysis with genetic insights, two private calls a month with Korosh, priority WhatsApp, and PDF reports on demand.',
